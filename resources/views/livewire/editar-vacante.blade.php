<form class="md:w-1/2 space-y-5" wire:submit.prevent='crearVacante'>
    ...
    <div>
        <x-label for="categoria" :value="__('Categotia')" />
            <select 
                id="categoria"
    ...
    <div>
        ...
        <textarea
            ...
            placeholder="Descripción gereral del puesto, experiencia."
    ...
    <div>
        ...
        <div class="my-5 w-80">
             ...
             <img src="{{ asset('storage/vacante/' . $imagen) }}" alt="{{'Imagen Vacante' . $titulo}}">
        </div>
